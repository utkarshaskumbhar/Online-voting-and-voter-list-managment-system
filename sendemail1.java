...
public class sendemail1 {
	...
	public boolean sendEmail(userinfo1 user) {
		boolean test=false;
		
		String toemail=userinfo1.getEmail();
		String fromEmail="**************";
		String password="********";
...
//			
			...
			m.setText("This is your Email Verification Mail.Please verify your account using this code : "+userinfo1.getCode());
